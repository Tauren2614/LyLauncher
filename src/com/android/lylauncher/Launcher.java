...
import com.android.lylauncher.ActionButton.SwipeListener;
import com.android.lylauncher.DockBar.DockBarListener;
import com.android.lylauncher.catalogue.AppCatalogueFilter;
import com.android.lylauncher.catalogue.AppCatalogueFilters;
import com.android.lylauncher.catalogue.AppGroupAdapter;
import com.android.lylauncher.catalogue.AppInfoMList;
	...
	*/
    ...
    void showSearchDialog(String initialQuery, boolean selectInitialQuery,
        ...
        if (appSearchData == null) {
            ...
            //[modify by Tauren 20120808 start]
            //appSearchData.putString(Search.SOURCE, "launcher-search");
            appSearchData.putString("source", "launcher-search");
            //[modify by Tauren 20120808 end]
        }
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.android.lylauncher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
